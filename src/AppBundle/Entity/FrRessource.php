 ...
 * FrRessource
 *
 * @ORM\Table(name="fr_ressource")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\FrRessourceRepository")
 * @Vich\Uploadable
 */
class FrRessource
{
     ...
     *
     * @Vich\UploadableField(mapping="frressource_image", fileNameProperty="imageName", size="imageSize")
     *
     * @var File
     */
    private $imageFile;
     ...
     * NOTE: This is not a mapped field of entity metadata, just a simple property.
     *
     * @Vich\UploadableField(mapping="frressource_brochure", fileNameProperty="brochureName", size="brochureSize")
     *
     * @var File
     */
